      ...
      <div className="border rounded-md border-black m-2 grid grid-cols-6 p-2 hover:bg-yellow-100 hover:cursor-pointer">
        ...
        <div className="col-span-4 lg:col-span-5">
          ...
          <div className="mt-5 flex gap-5">
            {glyph.is_study && (
              <p>
                <span className="bg-red-300 py-1 px-2 rounded-md">勉強会中</span>
              </p>
            )}
            {glyph.status === 'Public' && (
              <p>
                <span className="bg-lime-300 py-1 px-2 rounded-md">公開中</span>
              </p>
            )}
            {glyph.status === 'Private' && (
              <p>
                <span className="bg-orange-200 py-1 px-2 rounded-md">非公開</span>
              </p>
            )}
            {glyph.status === 'Draft' && (
              <p>
                <span className="bg-orange-200 py-1 px-2 rounded-md">下書き</span>
              </p>
            )}
          </div>
        </div>
